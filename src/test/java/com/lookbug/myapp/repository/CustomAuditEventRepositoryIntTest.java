package com.lookbug.myapp.repository;

import com.lookbug.myapp.GatewayApp;
import com.lookbug.myapp.config.Constants;
import com.lookbug.myapp.config.audit.AuditEventConverter;
import com.lookbug.myapp.domain.PersistentAuditEvent;
...
import static com.lookbug.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
